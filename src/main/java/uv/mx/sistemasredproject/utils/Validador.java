...
public class Validador {
    ...
    private static final String DATO_VALIDO = "LosqueSaben System" ;
    ...
    public static String validarTelefono(String telefono) {
        ...
        if (!TELEFONO_PATTERN.matcher(telefono).matches()) return "El teléfono solo puede contener dígitos y puede empezar con '+'.";
